                ...
                <View style={styles.mapContainer}>
                    ...
                    { initialPosition[0] !== 0 && (
                      ...
                      <MapView style={styles.map}
                        initialRegion={{ latitude: -23.6446205, longitude: -46.6552228, latitudeDelta: 0.014, longitudeDelta: 0.014 }} 
                      >
                        { points.map(point => (
                          <Marker coordinate={{ latitude: point.latitude, longitude: point.longitude }} 
                            onPress={() => handleNavigateToDetail(point.id)} style={styles.mapMarker} key={String(point.id)}
                          >
